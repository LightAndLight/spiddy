...
enum Cont<'expr, 'value> {
    AppL(Rc<Env<'expr, 'value>>, Hole, ExprRef<'expr>),
    AppR(Rc<Env<'expr, 'value>>, ExprRef<'expr>, Hole),
    AddU64L(Rc<Env<'expr, 'value>>, Hole, ExprRef<'expr>),
    AddU64R(u64, Hole),
}
    ...
    'heap: 'value,
{
    ...
    let mut env: Rc<Env<'expr, 'value>> = Rc::new(Vec::new());
